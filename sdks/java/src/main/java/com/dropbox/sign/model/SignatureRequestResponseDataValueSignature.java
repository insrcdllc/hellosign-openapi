...
public class SignatureRequestResponseDataValueSignature extends SignatureRequestResponseDataBase {
   ...
   */
  static public SignatureRequestResponseDataValueSignature init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, SignatureRequestResponseDataValueSignature.class);
  }

  static public SignatureRequestResponseDataValueSignature init(HashMap data) throws Exception {
...
static {
  ...
  JSON.registerDiscriminator(SignatureRequestResponseDataValueSignature.class, "type", mappings);
}
}
