...
public class SignatureRequestResponseDataValueInitials extends SignatureRequestResponseDataBase {
   ...
   */
  static public SignatureRequestResponseDataValueInitials init(String jsonData) throws Exception {
  ...
  **/
  ...
  @ApiModelProperty(value = "An input field for initials")
  ...
  public SignatureRequestResponseDataValueInitials value(String value) {
    this.value = value;
    return this;
  }
...
static {
  ...
  JSON.registerDiscriminator(SignatureRequestResponseDataValueInitials.class, "type", mappings);
}
}
