...
public class TemplateResponseDocumentFormFieldDropdown extends TemplateResponseDocumentFormFieldBase {
   ...
   */
  static public TemplateResponseDocumentFormFieldDropdown init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFormFieldDropdown.class);
  }

  static public TemplateResponseDocumentFormFieldDropdown init(HashMap data) throws Exception {
...
static {
  ...
  JSON.registerDiscriminator(TemplateResponseDocumentFormFieldDropdown.class, "type", mappings);
}
}
