...
@JsonPropertyOrder({
    TemplateResponseDocumentStaticFieldRadio.JSON_PROPERTY_TYPE
})
...
public class TemplateResponseDocumentStaticFieldRadio extends TemplateResponseDocumentStaticFieldBase {
   ...
   */
  static public TemplateResponseDocumentStaticFieldRadio init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentStaticFieldRadio.class);
  }

  static public TemplateResponseDocumentStaticFieldRadio init(HashMap data) throws Exception {
  ...
  **/
  ...
  /**
   * Return true if this TemplateResponseDocumentStaticFieldRadio object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateResponseDocumentStaticFieldRadio templateResponseDocumentStaticFieldRadio = (TemplateResponseDocumentStaticFieldRadio) o;
    return Objects.equals(this.type, templateResponseDocumentStaticFieldRadio.type) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateResponseDocumentStaticFieldRadio {\n");
...
static {
  ...
  JSON.registerDiscriminator(TemplateResponseDocumentStaticFieldRadio.class, "type", mappings);
}
}
