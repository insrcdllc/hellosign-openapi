...
public class TemplateResponseDocumentFormFieldDateSigned extends TemplateResponseDocumentFormFieldBase {
   ...
   */
  static public TemplateResponseDocumentFormFieldDateSigned init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFormFieldDateSigned.class);
  }

  static public TemplateResponseDocumentFormFieldDateSigned init(HashMap data) throws Exception {
