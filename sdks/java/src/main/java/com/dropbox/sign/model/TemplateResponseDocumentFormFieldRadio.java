...
public class TemplateResponseDocumentFormFieldRadio extends TemplateResponseDocumentFormFieldBase {
   ...
   */
  static public TemplateResponseDocumentFormFieldRadio init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFormFieldRadio.class);
  }

  static public TemplateResponseDocumentFormFieldRadio init(HashMap data) throws Exception {
...
static {
  ...
  JSON.registerDiscriminator(TemplateResponseDocumentFormFieldRadio.class, "type", mappings);
}
}
