...
public class AccountCreateResponse {
   ...
   */
  static public AccountCreateResponse init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, AccountCreateResponse.class);
  }

  static public AccountCreateResponse init(HashMap data) throws Exception {
  ...
  **/
  ...
  public AccountCreateResponse addWarningsItem(WarningResponse warningsItem) {
  ...
  **/
  ...
  /**
   * Return true if this AccountCreateResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, accountCreateResponse.account) &&
        Objects.equals(this.oauthData, accountCreateResponse.oauthData) &&
        Objects.equals(this.warnings, accountCreateResponse.warnings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, oauthData, warnings);
  }
  ...
  public Map<String, Object> createFormData() throws ApiException {
    ...
    if (oauthData != null) {
        if (isFileTypeOrListOfFiles(oauthData)) {
            fileTypeFound = true;
        }
        ...
        if (oauthData.getClass().equals(java.io.File.class) ||
            ...
            for(int i = 0; i< getListSize(oauthData); i++) {
                map.put("oauth_data[" + i + "]", getFromList(oauthData, i));
            }
        }
        else {
            map.put("oauth_data", JSON.getDefault().getMapper().writeValueAsString(oauthData));
        }
    }
    if (warnings != null) {
