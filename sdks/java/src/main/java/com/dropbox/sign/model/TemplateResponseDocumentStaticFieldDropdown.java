...
@JsonPropertyOrder({
    TemplateResponseDocumentStaticFieldDropdown.JSON_PROPERTY_TYPE
})
...
public class TemplateResponseDocumentStaticFieldDropdown extends TemplateResponseDocumentStaticFieldBase {
   ...
   */
  static public TemplateResponseDocumentStaticFieldDropdown init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentStaticFieldDropdown.class);
  }

  static public TemplateResponseDocumentStaticFieldDropdown init(HashMap data) throws Exception {
  ...
  **/
  ...
  /**
   * Return true if this TemplateResponseDocumentStaticFieldDropdown object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateResponseDocumentStaticFieldDropdown templateResponseDocumentStaticFieldDropdown = (TemplateResponseDocumentStaticFieldDropdown) o;
    return Objects.equals(this.type, templateResponseDocumentStaticFieldDropdown.type) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(TemplateResponseDocumentStaticFieldDropdown.class, "type", mappings);
}
}
