...
import com.dropbox.sign.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected Map<String, List<ServerConfiguration>> operationServers = new HashMap<String, List<ServerConfiguration>>() {{
    put("OAuthApi.oauthTokenGenerate", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
    ...
    put("OAuthApi.oauthTokenRefresh", new ArrayList<ServerConfiguration>(Arrays.asList(
      new ServerConfiguration(
        "https://app.hellosign.com",
        "No description provided",
        new HashMap<String, ServerVariable>()
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("OpenAPI-Generator/1.1-dev/java");
    ...
    if (auth instanceof HttpBearerAuth) {
      ...
      authentications.put("oauth2", new HttpBearerAuth("bearer"));
    }
